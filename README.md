...
3. Retrieves the currently running feature file name and its corresponding scenario name, then stores them in the environment variables 'featureName' and 'scenarioName'. These values can later be used in the glue code.
