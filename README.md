...
| sdkSignOff                         | boolean | false                             | If sdkSignOff is true, use test cases/fixtures from the folder matching sdkVersion and use the "next" OpenRPC for validation. If false, use both test cases/fixtures and OpenRPC from the matching sdkVersion.                                                                                                                            |
