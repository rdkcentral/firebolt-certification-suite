exports.ACCESSIBILITY_CLOSEDCAPTIONSSETTINGS = {
  ...
  setMethod: resolveAtRuntime('fcsSetters.setClosedCaptions'),
  setParams: {
...
exports.ACCESSIBILITY_VOICEGUIDANCESETTINGS = {
  ...
  setMethod: resolveAtRuntime('fcsSetters.setVoiceGuidance'),
  setParams: {
    attribute: resolveAtRuntime('{{attribute}}'),
    value: resolveAtRuntime('value'),
  },
...
exports.ACCESSIBILITY_AUDIODESCRIPTIONSETTINGS = {
  ...
  params: null,
  validationJsonPath: resolveAtRuntime(['result.{{attribute}}']),
  setMethod: resolveAtRuntime('fcsSetters.setAudioDescriptions'),
  setParams: {
    attribute: resolveAtRuntime('{{attribute}}'),
    value: resolveAtRuntime('value'),
  },
