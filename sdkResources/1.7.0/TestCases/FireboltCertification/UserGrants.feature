...
Feature: UserGrants
    ...
    Scenario: UserGrants.Grant R*2.2.2.1 - Validating Capabilities with denied pinChallenge and lifespan once
    ...
    @sdk @transport @requiresPlatformImplementation @Sev1
    Scenario: UserGrants.Capabilities R.2.1.1 - Validating Capability Grant access with one step option(only acknowledgeChallenge)
        Given the environment has been set up for 'userGrants' tests
        And 3rd party 'certification' app is launched
    ...
    @sdk @transport @requiresPlatformImplementation @Sev1
    Scenario: UserGrants.Capabilities R*2.2.2.2 - Validating Capabilities with granted pinChallenge and lifespan forever
        Given the environment has been set up for 'userGrants' tests
        And 3rd party 'certification' app is launched
        #Case-1
        And Framework registers 'pinChallenge' test provider
    ...
    @sdk @transportt @requiresPlatformImplementation @Sev1
    Scenario: UserGrants.Capabilities R*2.2.2.2 - Validating Capabilities with denied pinChallenge and lifespan forever
        Given the environment has been set up for 'userGrants' tests
        And 3rd party 'certification' app is launched
        #Case-1
        And Framework registers 'pinChallenge' test provider
    ...
    @sdk @transport @requiresPlatformImplementation @Sev1
    Scenario: UserGrants.Capabilities R*2.2.2.3 - Validating Capabilities with granted pinChallenge and lifespan appActive
        Given the environment has been set up for 'userGrants' tests
        And 3rd party 'certification' app is launched
        #Case-1
        And Framework registers 'pinChallenge' test provider
    ...
    @sdk @transport @requiresPlatformImplementation @Sev1
    Scenario: UserGrants.Capabilities R*2.2.2.3 - Validating Capabilities with denied pinChallenge and lifespan appActive
        Given the environment has been set up for 'userGrants' tests
        And 3rd party 'certification' app is launched
        #Case-1
        And Framework registers 'pinChallenge' test provider
    ...
    @sdk @transport @requiresPlatformImplementation @Sev1
    Scenario: UserGrants.Capabilities R*2.2.2.5 - Validating Capabilities with granted ackchallenge and lifespan of 60 sec
        Given the environment has been set up for 'userGrants' tests
        And 3rd party 'certification' app is launched
        #Case-1
        And Framework registers 'ackchallenge' test provider
    ...
    @sdk @transport @requiresPlatformImplementation @Sev1
    Scenario: UserGrants.Capabilities R*2.2.2.5 - Validating Capabilities with denied ackchallenge and lifespan of 60 sec
        Given the environment has been set up for 'userGrants' tests
        And 3rd party 'certification' app is launched
        # Case-1
        And Framework registers 'ackchallenge' test provider
    ...
    @sdk @transport @notSupported @requiresPlatformImplementation @Sev1
    Scenario: UserGrants.Capabilities R*2.2.2.5 - Validating Capabilities with granted pinChallenge and lifespan of 800sec - it should not ask for grant after reboot within ttl
        Given the environment has been set up for 'userGrants' tests
        And 3rd party 'certification' app is launched
        # Case-1
        And Framework registers 'pinChallenge' test provider
    ...
    @sdk @transport @notSupported @requiresPlatformImplementation @Sev1
    Scenario: UserGrants.Capabilities R*2.2.2.5 - Validating Capabilities with granted ackchallenge and lifespan of 60sec - it should ask for grant if reboot after ttl 
        Given the environment has been set up for 'userGrants' tests
        And 3rd party 'certification' app is launched
        # Case-1
        And Framework registers 'ackchallenge' test provider
    ...
    @sdk @transport @notSupported @requiresPlatformImplementation @Sev1
    Scenario: UserGrants.Capabilities R*2.2.2.5 - Validating Capabilities with denied pinChallenge and lifespan of 800sec - it should not ask for grant after reboot within ttl
        Given the environment has been set up for 'userGrants' tests
        And 3rd party 'certification' app is launched
        # Case-1
        And Framework registers 'pinChallenge' test provider
    ...
    @sdk @transport @notSupported @requiresPlatformImplementation @Sev1
    Scenario: UserGrants.Capabilities R*2.2.2.5 - Validating Capabilities with denied ackchallenge and lifespan of 60sec - it should ask for grant if reboot after ttl
        Given the environment has been set up for 'userGrants' tests
        And 3rd party 'certification' app is launched
        # Case-1
        And Framework registers 'ackchallenge' test provider
    ...
    @sdk @transport @requiresPlatformImplementation @Sev1
    Scenario: UserGrants.Capabilities R*2.2.3.4 - Validating Capabilities with privacySetting - autoApplyPolicy:always property-getter:true silently grant
        Given the environment has been set up for 'userGrants' tests
    ...
    @sdk @transport @requiresPlatformImplementation @Sev1
    Scenario Outline: UserGrants.Capabilities <ReqId> - <Scenario>
        Given the environment has been set up for 'userGrants' tests
        ...
        Examples:
            ...
            | Validating Capability autoApplyPolicy:always property-getter:false silently denied     | disable closedCaptions | expect error for closedCaptions settings | invalid request for closedCaptions settings | check if accessibility closedCaptions capability is granted with role as use | R*2.2.3.4 |
            | Validating Capability autoApplyPolicy:disallowed property-getter:false silently denied | disable voiceguidance  | expect error for voiceGuidance Settings  | invalid request for voiceGuidance settings  | check if accessibility voiceGuidance capability is granted with role as use  | R*2.2.3.6 |

    # grantPolicy having lifespan:appActive
    @sdk @transport @requiresPlatformImplementation @Sev1
    Scenario: UserGrants.Capabilities R*2.2.3.5 - Validating Capabilities with privacySetting - autoApplyPolicy:allowed property-getter:true silently grant
        Given the environment has been set up for 'userGrants' tests
        And 3rd party 'certification' app is launched
        And 1st party app invokes the 'Firebolt' API to 'set privacy allow watchHistory as true'
        And User 'starts' recording lifecycle history for '3rd party app'
    ...
    # grantPolicy having lifespan:appActive
    @sdk @transport @requiresPlatformImplementation @Sev1
    Scenario: UserGrants.Capabilities R*2.2.3.5 - Validating Capabilities with privacySetting - autoApplyPolicy:allowed property-getter:false grant
        Given the environment has been set up for 'userGrants' tests
        And 3rd party 'certification' app is launched
        And 1st party app invokes the 'Firebolt' API to 'set privacy allow watchHistory as false'
        And Framework registers 'pinChallenge' test provider
    ...
    # grantPolicy having lifespan:appActive
    @sdk @transport @requiresPlatformImplementation @Sev1
    Scenario: UserGrants.Capabilities R*2.2.3.5 - Validating Capabilities with privacySetting - autoApplyPolicy:allowed property-getter:false deny
        Given the environment has been set up for 'userGrants' tests
        And 3rd party 'certification' app is launched
        And 1st party app invokes the 'Firebolt' API to 'set privacy allow watchHistory as false'
        And Framework registers 'pinChallenge' test provider
    ...
    # grantPolicy having lifespan:appActive
    @sdk @transport @requiresPlatformImplementation @Sev1
    Scenario: UserGrants.Capabilities R*2.2.3.6 - Validating Capabilities with privacySetting - autoApplyPolicy:disallowed property-getter:true grant
        Given the environment has been set up for 'userGrants' tests
    ...
    # grantPolicy having lifespan:appActive
    @sdk @transport @requiresPlatformImplementation @Sev1
    Scenario: UserGrants.Capabilities R*2.2.3.6 - Validating Capabilities with privacySetting - autoApplyPolicy:disallowed property-getter:true deny
        Given the environment has been set up for 'userGrants' tests
        And 1st party app invokes the 'Firebolt' API to 'disable voiceguidance'
        And 3rd party 'certification' app is launched
        And 1st party app invokes the 'Firebolt' API to 'set privacy allow watchHistory as true'
    ...
    # grantPolicy having lifespan:appActive
    @sdk @transport @requiresPlatformImplementation @Sev1
    Scenario Outline: UserGrants.Capabilities R*2.2.3.7 - <Scenario>
        Given the environment has been set up for 'userGrants' tests
        And 3rd party 'certification' app is launched
        And 1st party app invokes the 'Firebolt' API to '<Key>'
        And Framework registers 'pinChallenge' test provider
        ...
        Examples:
            | Scenario                                                                | Key                                     |
            | Validating Capability autoApplyPolicy:never property-getter:true grant  | set privacy allow watchHistory as true  |
            | Validating Capability autoApplyPolicy:never property-getter:false grant | set privacy allow watchHistory as false |
    ...
    Scenario Outline: UserGrants.Capabilities R*2.2.3.7 - <Scenario>
        ...
        Examples:
            | Scenario                                                               | Key                                     |
            | Validating Capability autoApplyPolicy:never property-getter:true deny  | set privacy allow watchHistory as true  |
            | Validating Capability autoApplyPolicy:never property-getter:false deny | set privacy allow watchHistory as false |
    ...
    Scenario Outline: UserGrants.Capabilities <ReqId> - <Scenario>
        ...
        Examples:
            ...
            | Validating Capability updateProperty:true - property-getter:true deny property should be set to false | expect error for secondscreen device | invalid request for secondscreen device | false for privacy allow watchHistory | check if secondscreen device capability is granted with role use | R*2.2.3.9  |
            | Validating Capability updateProperty:false - property-getter:true deny property should not be updated | expect error for allow profile flags | invalid request for profile flags       | true for privacy allow watchHistory  | check if profile flags capability is granted with role use       | R*2.2.3.10 |

    # grantPolicy having lifespan:appActive
    @sdk @transport @requiresPlatformImplementation @Sev1
    Scenario Outline: UserGrants.Capabilities R*2.2.3.9 - <Scenario>
        Given the environment has been set up for 'userGrants' tests
        And 3rd party 'certification' app is launched
        ...
        Examples:
            ...
            | Validating Capability updateProperty:true - property-getter:false grant property should be set to false | set privacy allow watchHistory as false | get secondscreen device | expected secondscreen device                   | true for privacy allow watchHistory  | check if secondscreen device capability is granted with role use |
            | Validating Capability updateProperty:true - property-getter:true grant property should not be changed   | set privacy allow watchHistory as true  | get secondscreen device | expected secondscreen device                   | true for privacy allow watchHistory  | check if secondscreen device capability is granted with role use |
            | Validating Capability updateProperty:false - property-getter:false grant property should not be changed | set privacy allow watchHistory as false | allow profile flags     | expected profile flags for the current session | false for privacy allow watchHistory | check if profile flags capability is granted with role use       |
    ...
    @sdk @transport @notSupported @requiresPlatformImplementation @Sev1
    Scenario: UserGrants.Capabilities R*2.2.2.4 - Validating Capabilities with granted pinChallenge and lifespan powerActive - after reboot deny and validate
        Given the environment has been set up for 'userGrants' tests
        And 3rd party 'certification' app is launched
        # Case-1
        And Framework registers 'pinChallenge' test provider
    ...
    @sdk @transport @notSupported @requiresPlatformImplementation @Sev1
    Scenario: UserGrants.Capabilities R*2.2.2.4 - Validating Capabilities with denied pinChallenge and lifespan powerActive - after reboot grant and validate
        Given the environment has been set up for 'userGrants' tests
        And 3rd party 'certification' app is launched
        # Case-1
        And Framework registers 'pinChallenge' test provider
    ...
    @sdk @transport @requiresPlatformImplementation @Sev1
    Scenario Outline: UserGrants.request R.1.1 - <Scenario>
        Given the environment has been set up for 'userGrants' tests
        And Framework registers 'ackchallenge' test provider
        ...
        Examples:
            ...
            | Validating method response when granting for role use    | request grant for account uid capability with role use    | granted for account uid capability with role use    |
            | Validating method response when granting for role manage | request grant for account uid capability with role manage | granted for account uid capability with role manage |
    ...
    @sdk @transport @requiresPlatformImplementation @Sev1
    Scenario Outline: UserGrants.request R.1.2 - <Scenario>
        Given the environment has been set up for 'userGrants' tests
        And Framework registers 'ackchallenge' test provider
        When 1st party app invokes the 'Firebolt' API to '<API_Key>'
        And 3rd party 'certification' app is launched
        ...
        Examples:
            | Scenario                                                | API_Key                                                   | Validation_Key                                     |
            | Validating method response when denying for role use    | request grant for account uid capability with role use    | denied for account uid capability with role use    |
            | Validating method response when denying for role manage | request grant for account uid capability with role manage | denied for account uid capability with role manage |
    ...
    @sdk @transport @requiresPlatformImplementation @Sev1
    Scenario: UserGrants.request R.1.1 - Validating with role use, but grantpolicy having manage capability
        Given the environment has been set up for 'userGrants' tests
        And Framework registers 'pinChallenge' test provider
    ...
    @sdk @transport @requiresPlatformImplementation @Sev1
    Scenario: UserGrants.request R.1.2 - Validating for which grantpolicy is not present in manifest
        Given the environment has been set up for 'userGrants' tests
    ...
    @sdk @transport @requiresPlatformImplementation @Sev1
    Scenario: UserGrants.request - Validating method response by deferring
        Given the environment has been set up for 'userGrants' tests
        And Framework registers 'ackchallenge' test provider
    ...
    @sdk @transport @requiresPlatformImplementation @Sev1
    Scenario: UserGrants.request - Validating method response by deferring with timeout
        Given the environment has been set up for 'userGrants' tests
        And Framework registers 'ackchallenge' test provider
        When 1st party app invokes the 'Firebolt' API to 'request grant for account uid capability with role use'
        And 3rd party 'certification' app is launched
    ...
    @sdk @transport @requiresPlatformImplementation @Sev1
    Scenario: UserGrants.request R.1.1 - Validating method response when granting for role provide
        Given the environment has been set up for 'userGrants' tests
        And Framework registers 'ackchallenge' test provider
    ...
    @sdk @transport @requiresPlatformImplementation @Sev1
    Scenario: UserGrants.request R.1.2 - Validating method response when denying for role provide
        Given the environment has been set up for 'userGrants' tests
        And Framework registers 'ackchallenge' test provider
        When 1st party app invokes the 'Firebolt' API to 'request grant for account uid capability with role provide'
        And 3rd party 'certification' app is launched
    ...
    @sdk @transport @requiresPlatformImplementation @Sev1
    Scenario: UserGrants.Capabilities R.4.4.1.1 - Validating Capability Grant access with scope device
        Given the environment has been set up for 'userGrants' tests
        And 3rd party 'certification' app is launched
        And Framework registers 'pinChallenge' test provider
    ...
    @sdk @transport @requiresPlatformImplementation @Sev1
    Scenario: UserGrants.Capabilities R.4.4.1.1 - Validating Capability access denied for pinChallenge with scope device
        Given the environment has been set up for 'userGrants' tests
        And 3rd party 'certification' app is launched
        And Framework registers 'pinChallenge' test provider
