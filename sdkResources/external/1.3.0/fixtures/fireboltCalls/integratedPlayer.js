      ...
      data: [
        {
          ...
          validations: [
            {
              mode: 'staticContentValidation',
              type: this.STATIC_COMMON_VARIABLES.DEFAULT
                .PLAYER_ONSTATUS_STATE_BLOCKED_CONTENT_NOT_FOUND,
              description: 'Validation of player onStatus api',
            },
          ],
        },
          ...
          validations: [
            {
              mode: 'staticContentValidation',
              type: this.STATIC_COMMON_VARIABLES.DEFAULT
                .PLAYER_ONSTATUS_STATE_BLOCKED_CHANNEL_NOT_SCANNED,
              description: 'Validation of player onStatus api',
            },
          ],
        },
          ...
          validations: [
            {
              mode: 'staticContentValidation',
              type: this.STATIC_COMMON_VARIABLES.DEFAULT
                .PLAYER_ONSTATUS_STATE_BLOCKED_TECHNICAL_FAULT,
              description: 'Validation of player onStatus api',
            },
          ],
        },
          ...
          validations: [
            {
              mode: 'staticContentValidation',
              type: this.STATIC_COMMON_VARIABLES.DEFAULT
                .PLAYER_ONSTATUS_STATE_BLOCKED_CHANNEL_OFF_AIR,
              description: 'Validation of player onStatus api',
            },
          ],
        },
          ...
          validations: [
            {
              mode: 'staticContentValidation',
              type: this.STATIC_COMMON_VARIABLES.DEFAULT
                .PLAYER_ONSTATUS_STATE_BLOCKED_PLAYER_FAILURE,
              description: 'Validation of player onStatus api',
            },
          ],
        },
...
exports.PROVIDE_STATUS_WITH_MEDIASESSIONID = {
  ...
  params: this.STATIC_COMMON_VARIABLES.DEFAULT.PLAYER_PROVIDE_STATUS_MEDIASESSIONID,
};
...
exports.PROVIDE_STATUS_WITH_BLOCKED_REASON_AS_NO_NETWORK = {
  method: 'integratedproviderplayer_IntegratedPlayer.provideStatus',
  params: this.STATIC_COMMON_VARIABLES.DEFAULT.PLAYER_PROVIDE_STATE_BLOCKED_NO_NETWORK,
};
exports.PROVIDE_STATUS_WITH_BLOCKED_REASON_AS_CONTENT_NOT_FOUND = {
  method: 'integratedproviderplayer_IntegratedPlayer.provideStatus',
  params: this.STATIC_COMMON_VARIABLES.DEFAULT.PLAYER_PROVIDE_STATE_BLOCKED_CONTENT_NOT_FOUND,
};
exports.PROVIDE_STATUS_WITH_BLOCKED_REASON_AS_DRM_ERROR = {
  method: 'integratedproviderplayer_IntegratedPlayer.provideStatus',
  params: this.STATIC_COMMON_VARIABLES.DEFAULT.PLAYER_PROVIDE_STATE_BLOCKED_DRM_ERROR,
};
exports.PROVIDE_STATUS_WITH_BLOCKED_REASON_AS_NOT_ENTITLED = {
  method: 'integratedproviderplayer_IntegratedPlayer.provideStatus',
  params: this.STATIC_COMMON_VARIABLES.DEFAULT.PLAYER_PROVIDE_STATE_BLOCKED_NOT_ENTITLED,
};
exports.PROVIDE_STATUS_WITH_BLOCKED_REASON_AS_GEO_BLOCKED = {
  method: 'integratedproviderplayer_IntegratedPlayer.provideStatus',
  params: this.STATIC_COMMON_VARIABLES.DEFAULT.PLAYER_PROVIDE_STATE_BLOCKED_GEO_BLOCKED,
};
exports.PROVIDE_STATUS_WITH_BLOCKED_REASON_AS_CHANNEL_NOT_SCANNED = {
  method: 'integratedproviderplayer_IntegratedPlayer.provideStatus',
  params: this.STATIC_COMMON_VARIABLES.DEFAULT.PLAYER_PROVIDE_STATE_BLOCKED_CHANNEL_NOT_SCANNED,
};
exports.PROVIDE_STATUS_WITH_BLOCKED_REASON_AS_NO_SIGNAL = {
  method: 'integratedproviderplayer_IntegratedPlayer.provideStatus',
  params: this.STATIC_COMMON_VARIABLES.DEFAULT.PLAYER_PROVIDE_STATE_BLOCKED_NO_SIGNAL,
};
exports.PROVIDE_STATUS_WITH_BLOCKED_REASON_AS_TECHNICAL_FAULT = {
  method: 'integratedproviderplayer_IntegratedPlayer.provideStatus',
  params: this.STATIC_COMMON_VARIABLES.DEFAULT.PLAYER_PROVIDE_STATE_BLOCKED_TECHNICAL_FAULT,
};
exports.PROVIDE_STATUS_WITH_BLOCKED_REASON_AS_CHANNEL_OFF_AIR = {
  method: 'integratedproviderplayer_IntegratedPlayer.provideStatus',
  params: this.STATIC_COMMON_VARIABLES.DEFAULT.PLAYER_PROVIDE_STATE_BLOCKED_CHANNEL_OFF_AIR,
};
exports.PROVIDE_STATUS_WITH_BLOCKED_REASON_AS_PLAYER_FAILURE = {
  method: 'integratedproviderplayer_IntegratedPlayer.provideStatus',
  params: this.STATIC_COMMON_VARIABLES.DEFAULT.PLAYER_PROVIDE_STATE_BLOCKED_PLAYER_FAILURE,
};
...
exports.VALUE_OF_PLAYER_ONSTATUS_BLOCKED_REASON_CONTENT_NOT_FOUND = {
  ...
  validationJsonPath: 'eventResponse.status.blockedReason',
  content:
    this.STATIC_VALIDATION_VARIABLES.INTEGRATEDPLAYER.PLAYER_ONSTATUS_BLOCKED_CONTENT_NOT_FOUND,
};
...
exports.VALUE_OF_PLAYER_ONSTATUS_BLOCKED_REASON_CHANNEL_NOT_SCANNED = {
  ...
  validationJsonPath: 'eventResponse.status.blockedReason',
  content:
    this.STATIC_VALIDATION_VARIABLES.INTEGRATEDPLAYER.PLAYER_ONSTATUS_BLOCKED_CHANNEL_NOT_SCANNED,
};
...
exports.VALUE_OF_PLAYER_ONSTATUS_BLOCKED_REASON_TECHNICAL_FAULT = {
  ...
  validationJsonPath: 'eventResponse.status.blockedReason',
  content:
    this.STATIC_VALIDATION_VARIABLES.INTEGRATEDPLAYER.PLAYER_ONSTATUS_BLOCKED_TECHNICAL_FAULT,
};
exports.VALUE_OF_PLAYER_ONSTATUS_BLOCKED_REASON_CHANNEL_OFF_AIR = {
  event: 'IntegratedPlayer.onStatus',
  validationJsonPath: 'eventResponse.status.blockedReason',
  content:
    this.STATIC_VALIDATION_VARIABLES.INTEGRATEDPLAYER.PLAYER_ONSTATUS_BLOCKED_CHANNEL_OFF_AIR,
};
...
exports.LOAD_PLAYER_BEFORE_PLAYER_CREATION = {
  method: 'IntegratedPlayer.load',
  params: this.STATIC_COMMON_VARIABLES.DEFAULT.PLAYER_LOAD_BEFORE_PLAYER_CREATION,
  expected: 'error',
};
exports.START_PLAYING_THE_CONTENT_BEFORE_PLAYER_CREATION = {
  method: 'IntegratedPlayer.play',
  params: this.STATIC_COMMON_VARIABLES.DEFAULT.PLAYER_APPID_PLAYERID_BEFORE_PLAYER_CREATION,
  expected: 'error',
};
...
exports.SELECT_THE_GIVEN_AUDIO_TRACK_BEFORE_PLAYER_CREATION = {
  method: 'IntegratedPlayer.setAudioTrack',
  params: this.STATIC_COMMON_VARIABLES.DEFAULT.PLAYER_SET_TRACK_BEFORE_PLAYER_CREATION,
  expected: 'error',
};
...
exports.SET_POSITION_OF_PLAYER_IN_SECONDS_FOR_THE_MEDIA_BEFORE_PLAYER_CREATION = {
  method: 'IntegratedPlayer.seekTo',
  params: this.STATIC_COMMON_VARIABLES.DEFAULT.PLAYER_SET_POSITION_BEFORE_PLAYER_CREATION,
  expected: 'error',
};
exports.SET_SPEED_OF_PLAYER_BEFORE_PLAYER_CREATION = {
  method: 'IntegratedPlayer.setSpeed',
  params: this.STATIC_COMMON_VARIABLES.DEFAULT.PLAYER_SET_SPEED_BEFORE_PLAYER_CREATION,
  expected: 'error',
};
exports.PROVIDE_STATUS_BEFORE_PLAYER_CREATION = {
  method: 'IntegratedPlayer.provideStatus',
  params: this.STATIC_COMMON_VARIABLES.DEFAULT.PLAYER_PROVIDE_STATUS_BEFORE_PLAYER_CREATION,
  expected: 'error',
};
