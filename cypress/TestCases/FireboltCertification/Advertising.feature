...
Feature: Advertising
   ...
   Scenario Outline: Advertising.config - Validating API and Event responses when <Scenario>
      ...
      Examples:
         ...
         | limitAdTracking enabled With param True     | enable limitAdTracking  | get coppa as true   | advertising config    |
         | limitAdTracking disabled With param True    | disable limitAdTracking | get coppa as true   | advertising config    |
         | limitAdTracking enabled With param False    | enable limitAdTracking  | get coppa as false  | advertising config    |
         | limitAdTracking disabled With param False   | disable limitAdTracking | get coppa as false  | advertising config    |
         | limitAdTracking enabled Withcoppa as params | enable limitAdTracking  | get only coppa      | advertising config    |
         | limitAdTracking enabled with empty params   | enable limitAdTracking  | get empty parameter | advertising config    |
   ...
   Scenario Outline: Advertising.advertisingId - Validating API and Event Responses when <Scenario>
      ...
      Examples:
         ...
         | limitAdTracking disabled with scope browser            | enable limitAdTracking  | get advertisingId for scope browser              | limitAdTracking OFF for advertisingId |
         | limitAdTracking enabled with scope browser             | disable limitAdTracking | get advertisingId for scope browser              | limitAdTracking ON for advertisingId  |
         | limitAdTracking disabled with scope content            | enable limitAdTracking  | get advertisingId for scope content              | limitAdTracking OFF for advertisingId |
         | limitAdTracking enabled with scopt content             | disable limitAdTracking | get advertisingId for scope content              | limitAdTracking ON for advertisingId  |
         | limitAdTracking enabled withiout scope                 | disable limitAdTracking | get advertisingId without scope                  | limitAdTracking ON for advertisingId  |
         | limitAdTracking enabled with random string as scope ID | disable limitAdTracking | get advertisingId with scope id as random string | limitAdTracking ON for advertisingId  |
         | limitAdTracking enabled with empty string as scope ID  | disable limitAdTracking | get advertisingId with scope id as empty string  | limitAdTracking ON for advertisingId  |
