...
Feature: Authentication
   ...
   @sdk @transport
   Scenario Outline: Authentication.token - Get and validate method response content for <Scenario>
   ...
   @sdk @transport
   Scenario Outline: Authentication.<Method> - Get and validate method response content for <Scenario>
      When '3rd party app' invokes the 'Firebolt' API to '<API_Key>'
      Then 'Firebolt' platform responds with '<Validation_key>'
