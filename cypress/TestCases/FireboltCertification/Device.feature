Feature: Device
    ...
    Scenario Outline: Device.<Method> - Negative Scenario: <Scenario>
        ...
        Examples:
            ...
            | Invalid videoFormatOptions resolution with only width  | videoFormatSupported   | get videoFormatSupported with VideoFormatOptions resolution type with only width  | invalid parameter error for videoFormatSupported   |
            | Invalid videoFormatOptions resolution with only height | videoFormatSupported   | get videoFormatSupported with VideoFormatOptions resolution type with only height | invalid parameter error for videoFormatSupported   |
    ...
    Scenario Outline: Device.<method> - Positive Scenario: <Scenario>
        ...
        Examples:
            ...
            | validate device videoMode_480i                  | videoMode           | device onVideoModeChanged           | fetch videoMode              | device videoMode as 480i         | onVideoModeChanged with videoMode as 480i           | onVideoModeChanged event with audioMode as 480i         |
            | validate device videoMode_480p                  | videoMode           | device onVideoModeChanged           | fetch videoMode              | device videoMode as 480p         | onVideoModeChanged with videoMode as 480p           | onVideoModeChanged event with audioMode as 480p         |
            | validate device videoMode_576i25                | videoMode           | device onVideoModeChanged           | fetch videoMode              | device videoMode as 576i25       | onVideoModeChanged with videoMode as 576i25         | onVideoModeChanged event with audioMode as 576i25       |
            | validate device videoMode_576p50                | videoMode           | device onVideoModeChanged           | fetch videoMode              | device videoMode as 576p50       | onVideoModeChanged with videoMode as 576p50         | onVideoModeChanged event with audioMode as 576p50       |
            | validate device videoMode_576p60                | videoMode           | device onVideoModeChanged           | fetch videoMode              | device videoMode as 576p60       | onVideoModeChanged with videoMode as 576p60         | onVideoModeChanged event with audioMode as 576p60       |
            | validate device videoMode_720p50                | videoMode           | device onVideoModeChanged           | fetch videoMode              | device videoMode as 720p50       | onVideoModeChanged with videoMode as 720p50         | onVideoModeChanged event with audioMode as 720p50       |
            | validate device videoMode_720p60                | videoMode           | device onVideoModeChanged           | fetch videoMode              | device videoMode as 720p60       | onVideoModeChanged with videoMode as 720p60         | onVideoModeChanged event with audioMode as 720p60       |
            | validate device videoMode_1080i50               | videoMode           | device onVideoModeChanged           | fetch videoMode              | device videoMode as 1080i50      | onVideoModeChanged with videoMode as 1080i50        | onVideoModeChanged event with audioMode as 1080i50      |
            | validate device videoMode_1080i60               | videoMode           | device onVideoModeChanged           | fetch videoMode              | device videoMode as 1080i60      | onVideoModeChanged with videoMode as 1080i60        | onVideoModeChanged event with audioMode as 1080i60      |
            | validate device videoMode_1080p24               | videoMode           | device onVideoModeChanged           | fetch videoMode              | device videoMode as 1080p24      | onVideoModeChanged with videoMode as 1080p24        | onVideoModeChanged event with audioMode as 1080p24      |
            | validate device videoMode_1080p25               | videoMode           | device onVideoModeChanged           | fetch videoMode              | device videoMode as 1080p25      | onVideoModeChanged with videoMode as 1080p25        | onVideoModeChanged event with audioMode as 1080p25      |
            | validate device videoMode_1080p30               | videoMode           | device onVideoModeChanged           | fetch videoMode              | device videoMode as 1080p30      | onVideoModeChanged with videoMode as 1080p30        | onVideoModeChanged event with audioMode as 1080p30      |
            | validate device videoMode_1080p50               | videoMode           | device onVideoModeChanged           | fetch videoMode              | device videoMode as 1080p50      | onVideoModeChanged with videoMode as 1080p50        | onVideoModeChanged event with audioMode as 1080p50      |
            | validate device videoMode_1080p60               | videoMode           | device onVideoModeChanged           | fetch videoMode              | device videoMode as 1080p60      | onVideoModeChanged with videoMode as 1080p60        | onVideoModeChanged event with audioMode as 1080p60      |
            | validate device videoMode_2160p24               | videoMode           | device onVideoModeChanged           | fetch videoMode              | device videoMode as 2160p24      | onVideoModeChanged with videoMode as 2160p24        | onVideoModeChanged event with audioMode as 2160p24      |
            | validate device videoMode_2160p25               | videoMode           | device onVideoModeChanged           | fetch videoMode              | device videoMode as 2160p25      | onVideoModeChanged with videoMode as 2160p25        | onVideoModeChanged event with audioMode as 2160p25      |
            | validate device videoMode_2160p30               | videoMode           | device onVideoModeChanged           | fetch videoMode              | device videoMode as 2160p30      | onVideoModeChanged with videoMode as 2160p30        | onVideoModeChanged event with audioMode as 2160p30      |
            | validate device videoMode_2160p50               | videoMode           | device onVideoModeChanged           | fetch videoMode              | device videoMode as 2160p50      | onVideoModeChanged with videoMode as 2160p50        | onVideoModeChanged event with audioMode as 2160p50      |
            | validate device videoMode_2160p60               | videoMode           | device onVideoModeChanged           | fetch videoMode              | device videoMode as 2160p60      | onVideoModeChanged with videoMode as 2160p60        | onVideoModeChanged event with audioMode as 2160p60      |
            | validate device videoMode_4320p60               | videoMode           | device onVideoModeChanged           | fetch videoMode              | device videoMode as 4320p60      | onVideoModeChanged with videoMode as 4320p60        | onVideoModeChanged event with audioMode as 4320p60      |
            | validate device videoMode_unknown               | videoMode           | device onVideoModeChanged           | fetch videoMode              | device videoMode as unknown      | onVideoModeChanged with videoMode as unknown        | onVideoModeChanged event with audioMode as unknown      |
