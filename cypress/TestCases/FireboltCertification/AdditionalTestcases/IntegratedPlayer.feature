Feature: IntegratedPlayer
    ...
    Scenario: Positive Scenario : Create and validate broadcast player instance
        ...
        When 1st party app invokes the 'Firebolt' API to 'set audio track'
        Then 'Firebolt' platform responds to '1st party app' with 'value for set audio track'
        When 1st party app invokes the 'Firebolt' API to 'set captions track'
        Then 'Firebolt' platform responds to '1st party app' with 'value for set captions track'
        When 1st party app invokes the 'Firebolt' API to 'set position'
        Then 'Firebolt' platform responds to '1st party app' with 'value for set position'
        When 1st party app invokes the 'Firebolt' API to 'set speed'
        Then 'Firebolt' platform responds to '1st party app' with 'value for set speed'
        When 1st party app invokes the 'Firebolt' API to 'provide status'
        Then 'Firebolt' platform responds to '1st party app' with 'value for provide status'
