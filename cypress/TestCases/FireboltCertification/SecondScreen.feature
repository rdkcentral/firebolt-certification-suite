...
Feature: SecondScreen
   ...
   @sdk @transport @Sev1
   Scenario: SecondScreen.FriendlyName - Validating API and Event Responses when changing device Name
   ...
   @regression @sdk @requiresPlatformImplementation @notSupported @Sev2
