Feature: ClosedCaptions_Manage
    ...
    Scenario Outline: Closedcaptions.<Method> - Positive Scenario: <Scenario> with 'null' params
        ...
        Examples:
            ...
            | fontFamily        | fontFamily        | set fontFamily as null        | get fontFamily        | default value for fontFamily        | onFontFamilyChanged for closedcaptions with monospaced serif | closedcaptions onFontFamilyChanged        |
            | fontSize          | fontSize          | set fontSize as null          | get fontSize          | default value for fontSize          | onFontSizeChanged for closedcaptions with 1                  | closedcaptions onFontSizeChanged          |
            | fontColor         | fontColor         | set fontColor as null         | get fontColor         | default value for fontColor         | onFontColorChanged for closedcaptions with #ffffff           | closedcaptions onFontColorChanged         |
            | fontEdge          | fontEdge          | set fontEdge as null          | get fontEdge          | default value for fontEdge          | onFontEdgeChanged for closedcaptions with none               | closedcaptions onFontEdgeChanged          |
            | fontEdgeColor     | fontEdgeColor     | set fontEdgeColor as null     | get fontEdgeColor     | default value for fontEdgeColor     | onFontEdgeColorChanged for closedcaptions with #7F7F7F       | closedcaptions onFontEdgeColorChanged     |
            | fontOpacity       | fontOpacity       | set fontOpacity as null       | get fontOpacity       | default value for fontOpacity       | onFontOpacityChanged for closedcaptions with 100             | closedcaptions onFontOpacityChanged       |
            | backgroundColor   | backgroundColor   | set backgroundColor as null   | get backgroundColor   | default value for backgroundColor   | onBackgroundColorChanged for closedcaptions with #000000     | closedcaptions onBackgroundColorChanged   |
            | backgroundOpacity | backgroundOpacity | set backgroundOpacity as null | get backgroundOpacity | default value for backgroundOpacity | onBackgroundOpacityChanged for closedcaptions with 12        | closedcaptions onBackgroundOpacityChanged |
            | textAlign         | textAlign         | set textAlign as null         | get textAlign         | default value for textAlign         | onTextAlignChanged for closedcaptions with center            | closedcaptions onTextAlignChanged         |
            | textAlignVertical | textAlignVertical | set textAlignVertical as null | get textAlignVertical | default value for textAlignVertical | onTextAlignVerticalChanged for closedcaptions with middle    | closedcaptions onTextAlignVerticalChanged |
            | windowColor       | windowColor       | set windowColor as null       | get windowColor       | default value for windowColor       | onWindowColorChanged for closedcaptions with #000000         | closedcaptions onWindowColorChanged       |
            | windowOpacity     | windowOpacity     | set windowOpacity as null     | get windowOpacity     | default value for windowOpacity     | onWindowOpacityChanged for closedcaptions with 0             | closedcaptions onWindowOpacityChanged     |
