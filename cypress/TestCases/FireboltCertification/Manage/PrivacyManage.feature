Feature: Privacy_Manage
   ...
   Scenario Outline: Privacy.<Method> - Positive Scenario: <Scenario>
      ...
      Examples:
         ...
         | Enable allowResumePoints               | allowResumePoints              | privacy onAllowResumePointsChanged              | set privacy allow resumePoints as true               | get privacy allow resumePoints              | true for privacy allow resumePoints               | onAllowResumePointsChanged for privacy true               | null for privacy setAllowResumePoints              |
         | Disable allowResumePoints              | allowResumePoints              | privacy onAllowResumePointsChanged              | set privacy allow resumePoints as false              | get privacy allow resumePoints              | false for privacy allow resumePoints              | onAllowResumePointsChanged for privacy false              | null for privacy setAllowResumePoints              |
         | Enable allowUnentitledResumePoints     | allowUnentitledResumePoints    | privacy onAllowUnentitledResumePointsChanged    | set privacy allow unEntitledResumePoints as true     | get privacy allow unEntitledResumePoints    | true for privacy allow unEntitledResumePoints     | onAllowUnentitledResumePointsChanged for privacy true     | null for privacy setAllowUnentitledResumePoints    |
         | Disable allowUnentitledResumePoints    | allowUnentitledResumePoints    | privacy onAllowUnentitledResumePointsChanged    | set privacy allow unEntitledResumePoints as false    | get privacy allow unEntitledResumePoints    | false for privacy allow unEntitledResumePoints    | onAllowUnentitledResumePointsChanged for privacy false    | null for privacy setAllowUnentitledResumePoints    |
         | Enable allowWatchHistory               | allowWatchHistory              | privacy onAllowWatchHistoryChanged              | set privacy allow watchHistory as true               | get privacy allow watchHistory              | true for privacy allow watchHistory               | onAllowWatchHistoryChanged for privacy true               | null for privacy setAllowWatchHistory              |
         | Disable allowWatchHistory              | allowWatchHistory              | privacy onAllowWatchHistoryChanged              | set privacy allow watchHistory as false              | get privacy allow watchHistory              | false for privacy allow watchHistory              | onAllowWatchHistoryChanged for privacy false              | null for privacy setAllowWatchHistory              |
         | Enable allowProductAnalytics           | allowProductAnalytics          | privacy onAllowProductAnalyticsChanged          | set privacy allow productAnalytics as true           | get privacy allow productAnalytics          | true for privacy allow productAnalytics           | onAllowProductAnalyticsChanged for privacy true           | null for privacy setAllowProductAnalytics          |
         | Disable allowProductAnalytics          | allowProductAnalytics          | privacy onAllowProductAnalyticsChanged          | set privacy allow productAnalytics as false          | get privacy allow productAnalytics          | false for privacy allow productAnalytics          | onAllowProductAnalyticsChanged for privacy false          | null for privacy setAllowProductAnalytics          |
         | Enable allowPersonalization            | allowPersonalization           | privacy onAllowPersonalizationChanged           | set privacy allow personalization as true            | get privacy allow personalization           | true for privacy allow personalization            | onAllowPersonalizationChanged for privacy true            | null for privacy setAllowPersonalization           |
         | Disable allowPersonalization           | allowPersonalization           | privacy onAllowPersonalizationChanged           | set privacy allow personalization as false           | get privacy allow personalization           | false for privacy allow personalization           | onAllowPersonalizationChanged for privacy false           | null for privacy setAllowPersonalization           |
         | Enable allowUnentitledPersonalization  | allowUnentitledPersonalization | privacy onAllowUnentitledPersonalizationChanged | set privacy allow unEntitledpersonalization as true  | get privacy allow unEntitledpersonalization | true for privacy allow unEntitledpersonalization  | onAllowUnentitledPersonalizationChanged for privacy true  | null for privacy setAllowUnentitledPersonalization |
         | Disable allowUnentitledPersonalization | allowUnentitledPersonalization | privacy onAllowUnentitledPersonalizationChanged | set privacy allow unEntitledpersonalization as false | get privacy allow unEntitledpersonalization | false for privacy allow unEntitledpersonalization | onAllowUnentitledPersonalizationChanged for privacy false | null for privacy setAllowUnentitledPersonalization |
         | Enable allowRemoteDiagnostics          | allowRemoteDiagnostics         | privacy onAllowRemoteDiagnosticsChanged         | set privacy allow remoteDiagnostics as true          | get privacy allow remoteDiagnostics         | true for privacy allow remoteDiagnostics          | onAllowRemoteDiagnosticsChanged for privacy true          | null for privacy setAllowRemoteDiagnostics         |
         | Disable allowRemoteDiagnostics         | allowRemoteDiagnostics         | privacy onAllowRemoteDiagnosticsChanged         | set privacy allow remoteDiagnostics as false         | get privacy allow remoteDiagnostics         | false for privacy allow remoteDiagnostics         | onAllowRemoteDiagnosticsChanged for privacy false         | null for privacy setAllowRemoteDiagnostics         |
         | Enable allowPrimaryContentAdTargeting  | allowPrimaryContentAdTargeting | privacy onAllowPrimaryContentAdTargetingChanged | set privacy allow primaryContentAdTargeting as true  | get privacy allow primaryContentAdTargeting | true for privacy allow primaryContentAdTargeting  | onAllowPrimaryContentAdTargetingChanged for privacy true  | null for privacy setAllowPrimaryContentAdTargeting |
         | Disable allowPrimaryContentAdTargeting | allowPrimaryContentAdTargeting | privacy onAllowPrimaryContentAdTargetingChanged | set privacy allow primaryContentAdTargeting as false | get privacy allow primaryContentAdTargeting | false for privacy allow primaryContentAdTargeting | onAllowPrimaryContentAdTargetingChanged for privacy false | null for privacy setAllowPrimaryContentAdTargeting |
         | Enable allowPrimaryBrowseAdTargeting   | allowPrimaryBrowseAdTargeting  | privacy onAllowPrimaryBrowseAdTargetingChanged  | set privacy allow primaryBrowseAdTargeting as true   | get privacy allow primaryBrowseAdTargeting  | true for privacy allow primaryBrowseAdTargeting   | onAllowPrimaryBrowseAdTargetingChanged for privacy true   | null for privacy setAllowPrimaryBrowseAdTargeting  |
         | Disable allowPrimaryBrowseAdTargeting  | allowPrimaryBrowseAdTargeting  | privacy onAllowPrimaryBrowseAdTargetingChanged  | set privacy allow primaryBrowseAdTargeting as false  | get privacy allow primaryBrowseAdTargeting  | false for privacy allow primaryBrowseAdTargeting  | onAllowPrimaryBrowseAdTargetingChanged for privacy false  | null for privacy setAllowPrimaryBrowseAdTargeting  |
         | Enable allowAppContentAdTargeting      | allowAppContentAdTargeting     | privacy onAllowAppContentAdTargetingChanged     | set privacy allow appContentAdTargeting as true      | get privacy allow appContentAdTargeting     | true for privacy allow appContentAdTargeting      | onAllowAppContentAdTargetingChanged for privacy true      | null for privacy setAllowAppContentAdTargeting     |
         | Disable allowAppContentAdTargeting     | allowAppContentAdTargeting     | privacy onAllowAppContentAdTargetingChanged     | set privacy allow appContentAdTargeting as false     | get privacy allow appContentAdTargeting     | false for privacy allow appContentAdTargeting     | onAllowAppContentAdTargetingChanged for privacy false     | null for privacy setAllowAppContentAdTargeting     |
         | Enable allowACRCollection              | allowACRCollection             | privacy onAllowACRCollectionChanged             | set privacy allow ACRCollection as true              | get privacy allow ACRCollection             | true for privacy allow ACRCollection              | onAllowACRCollectionChanged for privacy true              | null for privacy setAllowACRCollection             |
         | Disable allowACRCollection             | allowACRCollection             | privacy onAllowACRCollectionChanged             | set privacy allow ACRCollection as false             | get privacy allow ACRCollection             | false for privacy allow ACRCollection             | onAllowACRCollectionChanged for privacy false             | null for privacy setAllowACRCollection             |
         | Enable allowCameraAnalytics            | allowCameraAnalytics           | privacy onAllowCameraAnalyticsChanged           | set privacy allow cameraAnalytics as true            | get privacy allow cameraAnalytics           | true for privacy allow cameraAnalytics            | onallowcameraanalyticschanged for privacy true            | null for privacy setAllowCameraAnalytics           |
         | Disable allowCameraAnalytics           | allowCameraAnalytics           | privacy onAllowCameraAnalyticsChanged           | set privacy allow cameraAnalytics as false           | get privacy allow cameraAnalytics           | false for privacy allow cameraAnalytics           | onallowcameraanalyticschanged for privacy false           | null for privacy setAllowCameraAnalytics           |
