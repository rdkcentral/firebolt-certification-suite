Feature: Discovery_Manage
    ...
    Scenario Outline: Discovery.onSignIn event - Positive Scenario: '<Scenario>'
        ...
        Examples:
            | Scenario             | Key                                   |
            | With entitlements    | notify signed in with entitlements    |
            | Without entitlements | notify signed in without entitlements |
    ...
    Scenario: Discovery.onSignOut event - Positive Scenario: Validating discovery onSignOut event
        ...
        And '3rd party app' invokes the 'Firebolt' API to 'notify signed out'
