Feature: UserInterest
    ...
    Scenario Outline: Discovery.userInterest - Positive Scenario: with interest type <Scenario>
        When 1st party app invokes the 'Firebolt' API to 'discovery onRequestUserInterest'
    ...
    Scenario Outline: 'Discovery_content.requestUserInterest - Positive Scenario: with type <Scenario>
        ...
        Examples:
            ...
            | interest and reason playlist     | interest reason playlist     | requestUserInterest with type interest reason playlist | onRequestUserInterest with type interest reason playlist   |
