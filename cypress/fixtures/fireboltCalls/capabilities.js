...
exports.CAPABILITIES = {
  ...
  params: resolveAtRuntime(
    'DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.{{value}}'
  ),
...
exports.DYNAMIC_FB_CALL_VARIABLES = {
  CAPABILITIES_VARIABLES: {
    CAPABILITIES: {
      ...
      SUPPORTED_USERGRANT_PINCHALLENGE: { value: 'xrn:firebolt:capability:usergrant:pinchallenge' },
      SUPPORTED_DEVICE_DISTRIBUTOR: { value: 'xrn:firebolt:capability:device:distributor' },
      SUPPORTED_NETWORK_STATUS: { value: 'xrn:firebolt:capability:network:status' },
      SUPPORTED_LOCALIZATION_TIMEZONE: { value: 'xrn:firebolt:capability:localization:time-zone' },
      SUPPORTED_PRIVACY_SETTINGS: { value: 'xrn:firebolt:capability:privacy:settings' },
      SUPPORTED_PROTOCOL_WIFI: { value: 'xrn:firebolt:capability:protocol:wifi' },
      SUPPORTED_USERGRANT_ACKNOWLEDGECHALLENGE: {
        value: 'xrn:firebolt:capability:usergrant:acknowledgechallenge',
      },
      SUPPORTED_GRANTS_STATE: { value: 'xrn:firebolt:capability:grants:state' },
      INFO_LIFECYCLE_READY: { capabilities: ['xrn:firebolt:capability:lifecycle:ready'] },
      SUPPORTED_LIFECYCLE_READY: { value: 'xrn:firebolt:capability:lifecycle:ready' },
      ...
      SUPPORTED_LIFECYCLE_STATE: { value: 'xrn:firebolt:capability:lifecycle:state' },
      SUPPORTED_LIFECYCLE_LAUNCH: { value: 'xrn:firebolt:capability:lifecycle:launch' },
      ...
      SUPPORTED_ADVERTISING_IDENTIFIER: { value: 'xrn:firebolt:capability:advertising:identifier' },
      SUPPORTED_ACCOUNT_ID: { value: 'xrn:firebolt:capability:account:id' },
      SUPPORTED_ACCOUNT_UID: { value: 'xrn:firebolt:capability:account:uid' },
      SUPPORTED_DISCOVERY_ENTITLEMENTS: {
        value: 'xrn:firebolt:capability:discovery:content-access',
      },
      SUPPORTED_DISCOVERY_SIGNINSTATUS: {
        value: 'xrn:firebolt:capability:discovery:sign-in-status',
      },
      SUPPORTED_DISCOVERY_WATCHNEXT: { value: 'xrn:firebolt:capability:discovery:watch-next' },
      SUPPORTED_DISCOVERY_WATCHED: { value: 'xrn:firebolt:capability:discovery:watched' },
      SUPPORTED_DISCOVERY_ENTITYINFO: { value: 'xrn:firebolt:capability:discovery:entity-info' },
      SUPPORTED_DISCOVERY_NAVIGATETO: { value: 'xrn:firebolt:capability:discovery:navigate-to' },
      SUPPORTED_DISCOVERY_POLICY: { value: 'xrn:firebolt:capability:discovery:policy' },
      SUPPORTED_DISCOVERY_PURCHASED_CONTENT: {
        value: 'xrn:firebolt:capability:discovery:purchased-content',
      },
      ...
      SUPPORTED_DEVICE_ID: { value: 'xrn:firebolt:capability:device:id' },
      SUPPORTED_DEVICE_INFO: { value: 'xrn:firebolt:capability:device:info' },
      SUPPORTED_DEVICE_MAKE: { value: 'xrn:firebolt:capability:device:make' },
      SUPPORTED_DEVICE_MODEL: { value: 'xrn:firebolt:capability:device:model' },
      SUPPORTED_DEVICE_NAME: { value: 'xrn:firebolt:capability:device:name' },
      SUPPORTED_DEVICE_SKU: { value: 'xrn:firebolt:capability:device:sku' },
      SUPPORTED_DEVICE_UID: { value: 'xrn:firebolt:capability:device:uid' },
      SUPPORTED_PROFILE_FLAGS: { value: 'xrn:firebolt:capability:profile:flags' },
      SUPPORTED_APPROVE_PURCHASE: { value: 'xrn:firebolt:capability:approve:purchase' },
      SUPPORTED_LOCALIZATION_LOCATION: { value: 'xrn:firebolt:capability:localization:location' },
      SUPPORTED_APPROVE_CONTENT: { value: 'xrn:firebolt:capability:approve:content' },
      SUPPORTED_TOKEN_DEVICE: { value: 'xrn:firebolt:capability:token:device' },
      SUPPORTED_TOKEN_PLATFORM: { value: 'xrn:firebolt:capability:token:platform' },
      SUPPORTED_TOKEN_ROOT: { value: 'xrn:firebolt:capability:token:root' },
      SUPPORTED_PROTOCOL_DIAL: { value: 'xrn:firebolt:capability:protocol:dial' },
      SUPPORTED_INPUT_KEYBOARD: { value: 'xrn:firebolt:capability:input:keyboard' },
      ...
      SUPPORTED_METRICS_GENERAL: { value: 'xrn:firebolt:capability:metrics:general' },
      SUPPORTED_METRICS_MEDIA: { value: 'xrn:firebolt:capability:metrics:media' },
      SUPPORTED_PRIVACY_ADVERTISING: { value: 'xrn:firebolt:capability:privacy:advertising' },
      SUPPORTED_SECURE_STORAGE: { value: 'xrn:firebolt:capability:storage:secure' },
      SUPPORTED_ADVERTISING_CONFIGURATION: {
        value: 'xrn:firebolt:capability:advertising:configuration',
      },
      SUPPORTED_LOCALIZATION_LOCALITY: { value: 'xrn:firebolt:capability:localization:locality' },
      ...
      SUPPORTED_LOCALIZATION_COUNTRYCODE: {
        value: 'xrn:firebolt:capability:localization:country-code',
      },
      SUPPORTED_LOCALIZATION_LANGUAGE: { value: 'xrn:firebolt:capability:localization:language' },
      SUPPORTED_LOCALIZATION_LOCALE: { value: 'xrn:firebolt:capability:localization:locale' },
      SUPPORTED_ACCESSIBILITY_CLOSEDCAPTIONS: {
        value: 'xrn:firebolt:capability:accessibility:closedcaptions',
      },
      SUPPORTED_ACCESSIBILITY_VOICEGUIDANCE: {
        value: 'xrn:firebolt:capability:accessibility:voiceguidance',
      },
      SUPPORTED_CAPABILITY_INFO: { value: 'xrn:firebolt:capability:capabilities:info' },
      SUPPORTED_CAPABILITY_REQUEST: { value: 'xrn:firebolt:capability:capabilities:request' },
      SUPPORTED_TOKEN_SESSION: { value: 'xrn:firebolt:capability:token:session' },
      ...
      SUPPORTED_INVALID_CAPABILITY: { value: 'invalid:firebolt:network:capability' },
      REQUEST_INFO_PARAM: {
...
exports.CHECK_AVAILABILITY_OF_KEYBOARD_CAPABILITY = {
  ...
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.GET_KEYBOARD,
};
...
exports.CHECK_AVAILABILITY_OF_ACKNOWLEDGECHALLENGE_CAPABILITY = {
  method: 'capabilities.available',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.GET_ACKNOWLEDGECHALLENGE,
};
...
exports.CHECK_AVAILABILITY_OF_PINCHALLENGE_CAPABILITY = {
  method: 'capabilities.available',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.GET_PINCHALLENGE,
};
...
exports.GET_INFO_OF_USERGRANT_PINCHALLENGE_CAPABILITY = {
  ...
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_USERGRANT_PINCHALLENGE,
};
exports.GET_INFO_OF_DEVICE_DISTRIBUTOR_CAPABILITY = {
  method: 'capabilities.info',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_DEVICE_DISTRIBUTOR,
};
exports.GET_INFO_OF_WIFI_NETWORKSTATUS_CAPABILITY = {
  method: 'capabilities.info',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_NETWORK_STATUS,
};
exports.GET_INFO_OF_LOCALIZATION_TIMEZONE_CAPABILITY = {
  method: 'capabilities.info',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_LOCALIZATION_TIMEZONE,
};
exports.GET_INFO_OF_PRIVACY_SETTINGS_CAPABILITY = {
  method: 'capabilities.info',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.PRIVACY_SETTINGS_INFO_PARAM,
};
exports.GET_INFO_OF_WIFI_PROTOCOL_CAPABILITY = {
  method: 'capabilities.info',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_PROTOCOL_WIFI,
};
exports.GET_INFO_OF_USERGRANT_ACKNOWLEDGECHALLENGE_CAPABILITY = {
  method: 'capabilities.info',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES
      .INFO_USERGRANT_ACKNOWLEDGECHALLENGE,
};
exports.GET_INFO_OF_GRANTS_STATE_CAPABILITY = {
  method: 'capabilities.info',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_GRANTS_STATE,
};
exports.EXPECTED_VALUE_FOR_SUPPORTED_API = {
  method: 'capabilities.supported',
  validationJsonPath: 'result',
  content: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES_CONTENT.supported,
};
exports.EXPECTED_VALUE_FOR_INFO_API = {
  method: 'capabilities.info',
  validationJsonPath: 'result',
  content: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES_CONTENT.info,
};
...
exports.CHECK_IF_DEVICE_DISTRIBUTOR_CAPABILITY_IS_SUPPORTED = {
  method: 'capabilities.supported',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.SUPPORTED_DEVICE_DISTRIBUTOR,
};
exports.CHECK_IF_WIFI_NETWORKSTATUS_CAPABILITY_IS_SUPPORTED = {
  method: 'capabilities.supported',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.SUPPORTED_NETWORK_STATUS,
};
...
exports.CHECK_IF_PRIVACY_SETTINGS_CAPABILITY_IS_SUPPORTED = {
  method: 'capabilities.supported',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.SUPPORTED_PRIVACY_SETTINGS,
};
exports.CHECK_IF_WIFI_PROTOCOL_CAPABILITY_IS_SUPPORTED = {
  method: 'capabilities.supported',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.SUPPORTED_PROTOCOL_WIFI,
};
...
exports.CHECK_IF_FOR_GRANTS_STATE_CAPABILITY_IS_SUPPORTED = {
  method: 'capabilities.supported',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.SUPPORTED_GRANTS_STATE,
};

exports.GET_INFO_OF_LIFECYCLE_READY_CAPABILITY = {
  method: 'capabilities.info',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_LIFECYCLE_READY,
};
exports.CHECK_IF_LIFECYCLE_READY_CAPABILITY_IS_SUPPORTED = {
  method: 'capabilities.supported',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.SUPPORTED_LIFECYCLE_READY,
};
...
exports.GET_INFO_OF_LIFECYCLE_STATE_CAPABILITY = {
  method: 'capabilities.info',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_LIFECYCLE_STATE,
};
exports.CHECK_IF_LIFECYCLE_STATE_CAPABILITY_IS_SUPPORTED = {
  method: 'capabilities.supported',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.SUPPORTED_LIFECYCLE_STATE,
};
...
exports.GET_INFO_OF_LIFECYCLE_LAUNCH_CAPABILITY = {
  method: 'capabilities.info',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_LIFECYCLE_LAUNCH,
};
exports.CHECK_IF_LIFECYCLE_LAUNCH_CAPABILITY_IS_SUPPORTED = {
  method: 'capabilities.supported',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.SUPPORTED_LIFECYCLE_LAUNCH,
};
...
exports.GET_INFO_OF_ADVERTISING_IDENTIFIER_CAPABILITY = {
  method: 'capabilities.info',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_ADVERTISING_IDENTIFIER,
};
...
exports.GET_INFO_OF_ACCOUNT_ID_CAPABILITY = {
  method: 'capabilities.info',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_ACCOUNT_ID,
};
exports.CHECK_IF_ACCOUNT_ID_CAPABILITY_IS_SUPPORTED = {
  method: 'capabilities.supported',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.SUPPORTED_ACCOUNT_ID,
};
...
exports.GET_INFO_OF_ACCOUNT_UID_CAPABILITY = {
  method: 'capabilities.info',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_ACCOUNT_UID,
};
exports.CHECK_IF_ACCOUNT_UID_CAPABILITY_IS_SUPPORTED = {
  method: 'capabilities.supported',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.SUPPORTED_ACCOUNT_UID,
};
...
exports.GET_INFO_OF_DISCOVERY_SIGNINSTATUS_CAPABILITY = {
  method: 'capabilities.info',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_DISCOVERY_SIGNINSTATUS,
};
...
exports.GET_INFO_OF_DISCOVERY_WATCHNEXT_CAPABILITY = {
  method: 'capabilities.info',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_DISCOVERY_WATCHNEXT,
};
exports.CHECK_IF_DISCOVERY_WATCHNEXT_CAPABILITY_IS_SUPPORTED = {
  method: 'capabilities.supported',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES
      .SUPPORTED_DISCOVERY_WATCHNEXT,
};
...
exports.GET_INFO_OF_DISCOVERY_WATCHED_CAPABILITY = {
  method: 'capabilities.info',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_DISCOVERY_WATCHED,
};
exports.CHECK_IF_DISCOVERY_WATCHED_CAPABILITY_IS_SUPPORTED = {
  method: 'capabilities.supported',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.SUPPORTED_DISCOVERY_WATCHED,
};
...
exports.GET_INFO_OF_DISCOVERY_ENTITYINFO_CAPABILITY = {
  method: 'capabilities.info',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_DISCOVERY_ENTITYINFO,
};
exports.CHECK_IF_DISCOVERY_ENTITYINFO_CAPABILITY_IS_SUPPORTED = {
  method: 'capabilities.supported',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES
      .SUPPORTED_DISCOVERY_ENTITYINFO,
};
...
exports.GET_INFO_OF_DISCOVERY_NAVIGATETO_CAPABILITY = {
  method: 'capabilities.info',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_DISCOVERY_NAVIGATETO,
};
exports.CHECK_IF_DISCOVERY_NAVIGATETO_CAPABILITY_IS_SUPPORTED = {
  method: 'capabilities.supported',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES
      .SUPPORTED_DISCOVERY_NAVIGATETO,
};
...
exports.GET_INFO_OF_DISCOVERY_POLICY_CAPABILITY = {
  method: 'capabilities.info',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_DISCOVERY_POLICY,
};
exports.CHECK_IF_DISCOVERY_POLICY_CAPABILITY_IS_SUPPORTED = {
  method: 'capabilities.supported',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.SUPPORTED_DISCOVERY_POLICY,
};
...
exports.GET_INFO_OF_KEYBOARD_INPUT_CAPABILITY = {
  method: 'capabilities.info',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_INPUT_KEYBOARD,
};
exports.CHECK_IF_KEYBOARD_INPUT_CAPABILITY_IS_SUPPORTED = {
  method: 'capabilities.supported',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.SUPPORTED_INPUT_KEYBOARD,
};
...
exports.GET_INFO_OF_LOCALIZATION_LOCATION_CAPABILITY = {
  method: 'capabilities.info',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_LOCALIZATION_LOCATION,
};
...
exports.GET_INFO_OF_PROTOCOLDIAL_CAPABILITY = {
  method: 'capabilities.info',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_PROTOCOL_DIAL,
};
exports.CHECK_IF_PROTOCOLDIAL_CAPABILITY_IS_SUPPORTED = {
  method: 'capabilities.supported',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.SUPPORTED_PROTOCOL_DIAL,
};
...
exports.GET_INFO_OF_AUTHENTICATION_TOKEN_DEVICE_CAPABILITY = {
  method: 'capabilities.info',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_TOKEN_DEVICE,
};
exports.CHECK_IF_AUTHENTICATION_TOKEN_DEVICE_CAPABILITY_IS_SUPPORTED = {
  method: 'capabilities.supported',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.SUPPORTED_TOKEN_DEVICE,
};
...
exports.GET_INFO_OF_AUTHENTICATION_TOKEN_PLATFORM_CAPABILITY = {
  method: 'capabilities.info',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_TOKEN_PLATFORM,
};
exports.CHECK_IF_AUTHENTICATION_TOKEN_PLATFORM_CAPABILITY_IS_SUPPORTED = {
  method: 'capabilities.supported',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.SUPPORTED_TOKEN_PLATFORM,
};
...
exports.GET_INFO_OF_AUTHENTICATION_TOKEN_ROOT_CAPABILITY = {
  method: 'capabilities.info',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_TOKEN_ROOT,
};
exports.CHECK_IF_AUTHENTICATION_TOKEN_ROOT_CAPABILITY_IS_SUPPORTED = {
  method: 'capabilities.supported',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.SUPPORTED_TOKEN_ROOT,
};
...
exports.GET_INFO_OF_APPROVECONTENT_CAPABILITY = {
  method: 'capabilities.info',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_APPROVE_CONTENT,
};
exports.CHECK_IF_APPROVECONTENT_CAPABILITY_IS_SUPPORTED = {
  method: 'capabilities.supported',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.SUPPORTED_APPROVE_CONTENT,
};
...
exports.GET_INFO_OF_PROFILE_APPROVEPURCHASE_CAPABILITY = {
  method: 'capabilities.info',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_APPROVE_PURCHASE,
};
exports.CHECK_IF_PROFILE_APPROVEPURCHASE_CAPABILITY_IS_SUPPORTED = {
  method: 'capabilities.supported',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.SUPPORTED_APPROVE_PURCHASE,
};
...
exports.GET_INFO_OF_PROFILE_FLAGS_CAPABILITY = {
  method: 'capabilities.info',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_PROFILE_FLAGS,
};
exports.CHECK_IF_PROFILE_FLAGS_CAPABILITY_IS_SUPPORTED = {
  method: 'capabilities.supported',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.SUPPORTED_PROFILE_FLAGS,
};
...
exports.GET_INFO_OF_DEVICE_ID_CAPABILITY = {
  method: 'capabilities.info',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_DEVICE_ID,
};
exports.CHECK_IF_DEVICE_ID_CAPABILITY_IS_SUPPORTED = {
  method: 'capabilities.supported',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.SUPPORTED_DEVICE_ID,
};
...
exports.GET_INFO_OF_DEVICE_INFO_CAPABILITY = {
  method: 'capabilities.info',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_DEVICE_INFO,
};
exports.CHECK_IF_DEVICE_INFO_CAPABILITY_IS_SUPPORTED = {
  method: 'capabilities.supported',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.SUPPORTED_DEVICE_INFO,
};
...
exports.GET_INFO_OF_DEVICE_MAKE_CAPABILITY = {
  method: 'capabilities.info',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_DEVICE_MAKE,
};
exports.CHECK_IF_DEVICE_MAKE_CAPABILITY_IS_SUPPORTED = {
  method: 'capabilities.supported',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.SUPPORTED_DEVICE_MAKE,
};
...
exports.GET_INFO_OF_DEVICE_MODEL_CAPABILITY = {
  method: 'capabilities.info',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_DEVICE_MODEL,
};
exports.CHECK_IF_DEVICE_MODEL_CAPABILITY_IS_SUPPORTED = {
  method: 'capabilities.supported',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.SUPPORTED_DEVICE_MODEL,
};
...
exports.GET_INFO_OF_DEVICE_SKU_CAPABILITY = {
  method: 'capabilities.info',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_DEVICE_SKU,
};
exports.CHECK_IF_DEVICE_SKU_CAPABILITY_IS_SUPPORTED = {
  method: 'capabilities.supported',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.SUPPORTED_DEVICE_SKU,
};
...
exports.GET_INFO_OF_DEVICE_UID_CAPABILITY = {
  method: 'capabilities.info',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_DEVICE_UID,
};
exports.CHECK_IF_DEVICE_UID_CAPABILITY_IS_SUPPORTED = {
  method: 'capabilities.supported',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.SUPPORTED_DEVICE_UID,
};
...
exports.GET_INFO_OF_METRICS_GENERAL_CAPABILITY = {
  method: 'capabilities.info',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_METRICS_GENERAL,
};
exports.CHECK_IF_METRICS_GENERAL_CAPABILITY_IS_SUPPORTED = {
  method: 'capabilities.supported',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.SUPPORTED_METRICS_GENERAL,
};
...
exports.GET_INFO_OF_METRICS_MEDIA_CAPABILITY = {
  method: 'capabilities.info',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_METRICS_MEDIA,
};
exports.CHECK_IF_METRICS_MEDIA_CAPABILITY_IS_SUPPORTED = {
  method: 'capabilities.supported',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.SUPPORTED_METRICS_MEDIA,
};
...
exports.GET_INFO_OF_PRIVACY_ADVERTISING_CAPABILITY = {
  method: 'capabilities.info',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_PRIVACY_ADVERTISING,
};
exports.CHECK_IF_PRIVACY_ADVERTISING_CAPABILITY_IS_SUPPORTED = {
  method: 'capabilities.supported',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES
      .SUPPORTED_PRIVACY_ADVERTISING,
};
...
exports.GET_INFO_OF_LOCALIZATION_LOCALITY_CAPABILITY = {
  method: 'capabilities.info',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_LOCALIZATION_LOCALITY,
};
...
exports.GET_INFO_OF_LOCALIZATION_POSTALCODE_CAPABILITY = {
  method: 'capabilities.info',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_LOCALIZATION_POSTALCODE,
};
...
exports.GET_INFO_OF_LOCALIZATION_LANGUAGE_CAPABILITY = {
  method: 'capabilities.info',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_LOCALIZATION_LANGUAGE,
};
...
exports.GET_INFO_OF_LOCALIZATION_LOCALE_CAPABILITY = {
  method: 'capabilities.info',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_LOCALIZATION_LOCALE,
};
exports.CHECK_IF_LOCALIZATION_LOCALE_CAPABILITY_IS_SUPPORTED = {
  method: 'capabilities.supported',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES
      .SUPPORTED_LOCALIZATION_LOCALE,
};
...
exports.GET_INFO_OF_DEVICE_NAME_CAPABILITY = {
  method: 'capabilities.info',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_DEVICE_NAME,
};
exports.CHECK_IF_DEVICE_NAME_CAPABILITY_IS_SUPPORTED = {
  method: 'capabilities.supported',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.SUPPORTED_DEVICE_NAME,
};
exports.CHECK_IF_DEVICE_NAME_CAPABILITY_IS_PERMITTED = {
  method: 'capabilities.permitted',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.PERMITTED_DEVICE_NAME,
};
exports.GET_INFO_OF_AUTHENTICATION_TOKEN_SESSION_CAPABILITY = {
  method: 'capabilities.info',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_TOKEN_SESSION,
};
exports.CHECK_IF_AUTHENTICATION_TOKEN_SESSION_CAPABILITY_IS_SUPPORTED = {
  method: 'capabilities.supported',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.SUPPORTED_TOKEN_SESSION,
};
...
exports.GET_INFO_OF_SECURE_STORAGE_CAPABILITY = {
  method: 'capabilities.info',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.SECURE_STORAGE_INFO_PARAM,
};
exports.CHECK_IF_SECURE_STORAGE_CAPABILITY_IS_SUPPORTED = {
  method: 'capabilities.supported',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.SUPPORTED_SECURE_STORAGE,
};
...
exports.GET_INFO_OF_CAPABILITY_INFO_CAPABILITY = {
  method: 'capabilities.info',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.CAPABILITY_INFO_INFO_PARAM,
};
exports.CHECK_IF_CAPABILITY_INFO_CAPABILITY_IS_SUPPORTED = {
  method: 'capabilities.supported',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.SUPPORTED_CAPABILITY_INFO,
};
...
exports.GET_INFO_OF_CAPABILITIES_WITH_INVALID_CATEGORY = {
  method: 'capabilities.info',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_INVALID_CATEGORY,
  expected: 'error',
};
...
exports.GET_INFO_OF_CAPABILITIES_WITH_EMPTY_CAPABILITIES = {
  method: 'capabilities.info',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INFO_EMPTY_CAPABILITIES,
  expected: 'error',
};
exports.GET_PERMITTED_CAPABILITIES_WITH_INVALID_ROLE = {
  method: 'capabilities.permitted',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.WIFI_INVALID_ROLE_PARAM,
  expected: 'error',
};
exports.GET_PERMITTED_CAPABILITIES_WITH_INVALID_CAPABILITY = {
  method: 'capabilities.permitted',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.INVALID_CAPABILITY,
  expected: 'error',
};
exports.CHECK_AVAILABILITY_OF_CAPABILITIES_WITH_INVALID_CAPABILITY = {
  method: 'capabilities.available',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.KEYBOARD_INVALID_CAPABILITY,
  expected: 'error',
};
...
exports.GET_SUPPORTED_CAPABILITIES_INVALID_CAPABILITY = {
  method: 'capabilities.supported',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.SUPPORTED_INVALID_CAPABILITY,
  expected: 'error',
};
...
exports.GET_GRANTED_CAPABILITIES_WITH_RANDOM_STRING_CAPABILITY = {
  method: 'capabilities.granted',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.GRANTED_NULL_CAPABILITY,
  expected: 'error',
};
exports.GET_GRANTED_CAPABILITIES_WITH_NUMBER_CAPABILITY = {
  method: 'capabilities.granted',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.GRANTED_NUMBER_CAPABILITY,
  expected: 'error',
};
exports.GET_GRANTED_CAPABILITIES_WITH_BOOLEAN_CAPABILITY = {
  method: 'capabilities.granted',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.GRANTED_BOOLEAN_CAPABILITY,
  expected: 'error',
};
exports.GET_GRANTED_CAPABILITIES_WITH_ARRAY_CAPABILITY = {
  method: 'capabilities.granted',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.GRANTED_ARRAY_CAPABILITY,
  expected: 'error',
};
exports.GET_GRANTED_CAPABILITIES_WITH_STRING_OPTIONS = {
  method: 'capabilities.granted',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.GRANTED_STRING_OPTIONS,
  expected: 'error',
};
exports.GET_GRANTED_CAPABILITIES_WITH_NUMBER_OPTIONS = {
  method: 'capabilities.granted',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.GRANTED_NUMBER_OPTIONS,
  expected: 'error',
};
exports.GET_GRANTED_CAPABILITIES_WITH_BOOLEAN_OPTIONS = {
  method: 'capabilities.granted',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.GRANTED_BOOLEAN_OPTIONS,
  expected: 'error',
};
exports.GET_GRANTED_CAPABILITIES_WITH_ARRAY_OPTIONS = {
  method: 'capabilities.granted',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.GRANTED_ARRAY_OPTIONS,
  expected: 'error',
};
exports.CAPABILITIES_GRANTED_WITH_INVALID_OPTIONS_ROLE = {
  method: 'capabilities.granted',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.GRANTED_INVALID_OPTIONS_ROLE,
  expected: 'error',
};
...
exports.CAPABILITIES_ONAVAILABLE = {
  ...
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.ONAVAILBLE_KEYBOARD,
};
exports.EXPECTED_VALUE_FOR_CAPABILITIES_ONAVAILABLE = {
  event: 'capabilities.onAvailable',
  validationJsonPath: 'eventResponse',
  content: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.ONAVAILABLE,
};
...
exports.CAPABILITIES_ONUNAVAILABLE = {
  ...
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.ONUNAVAILBLE_KEYBOARD,
};
exports.EXPECTED_VALUE_FOR_CAPABILITIES_ONUNAVAILABLE = {
  event: 'capabilities.onUnavailable',
  validationJsonPath: 'eventResponse',
  content: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.ONUNAVAILABLE,
};
exports.CAPABILITIES_ONGRANTED = {
  method: 'capabilities.onGranted',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.ONGRANTED_DEVICE_ID_ROLE_USE,
};
...
exports.CAPABILITIES_ONREVOKED = {
  ...
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.ONREVOKED_DEVICE_ID_ROLE_USE,
};
exports.EXPECTED_VALUE_FOR_CAPABILITIES_ONGRANTED = {
  event: 'capabilities.onGranted',
  validationJsonPath: 'eventResponse',
  content: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.ONGRANTED,
};
exports.EXPECTED_VALUE_FOR_CAPABILITIES_ONREVOKED = {
  event: 'capabilities.onRevoked',
  validationJsonPath: 'eventResponse',
  content: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.ONREVOKED,
};
exports.GET_INFO_OF_CAPABILITY_REQUEST_CAPABILITY = {
  method: 'capabilities.info',
  params: this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.REQUEST_INFO_PARAM,
};
exports.GET_CAPABILITYINFO_OF_REQUEST_CAPABILITY = {
  method: 'capabilities.request',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.REQUEST_CAPABILITY_REQUEST,
};
...
exports.CHECK_IF_CAPABILITY_REQUEST_CAPABILITY_IS_SUPPORTED = {
  method: 'capabilities.supported',
  params:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES.SUPPORTED_CAPABILITY_REQUEST,
};
exports.EXPECTED_CAPABILITY_IS_REQUESTED = {
  method: 'capabilities.request',
  validationJsonPath: 'result',
  content:
    this.DYNAMIC_FB_CALL_VARIABLES.CAPABILITIES_VARIABLES.CAPABILITIES_CONTENT.CAPABILITIES_REQUEST,
};
