...
exports.SETSECURE_VALUE_FOR_KEY_AUTHTESTTOKENDEVICE1 = {
  method: 'securestorage.set',
  params: this.STATIC_VARIABLES.SECURESTORAGE_VARIABLES.SET_DEVICE1,
};
exports.SETSECURE_VALUE_FOR_KEY_AUTHTESTTOKENDEVICE2 = {
  method: 'securestorage.set',
  params: this.STATIC_VARIABLES.SECURESTORAGE_VARIABLES.SET_DEVICE2,
};
exports.SETSECURE_VALUE_FOR_KEY_AUTHTESTTOKENACCOUNT1 = {
  method: 'securestorage.set',
  params: this.STATIC_VARIABLES.SECURESTORAGE_VARIABLES.SET_ACCOUNT1,
};
exports.SETSECURE_VALUE_FOR_KEY_AUTHTESTTOKENACCOUNT2 = {
  method: 'securestorage.set',
...
exports.SETSECURE_VALUE_WITH_SCOPE_AS_DEVICE_AND_TTL_AS_50 = {
  method: 'securestorage.set',
  params: this.STATIC_VARIABLES.SECURESTORAGE_VARIABLES.SET_DEVICE_TTL,
};
exports.SETSECURE_VALUE_WITH_SCOPE_AS_ACCOUNT_AND_TTL_AS_50 = {
  method: 'securestorage.set',
