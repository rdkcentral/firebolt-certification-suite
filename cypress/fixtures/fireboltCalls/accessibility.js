                ...
                validations: [
                    {
                        mode: "staticContentValidation",
                        type: resolveAtRuntime("value"),
                        description: resolveAtRuntime("Validating that accessibility.voiceGuidanceSettings {{attribute}} is {{value}}")
                    }
                ]
            }
        ]
                ...
                validations: [
                    {
                        mode: "staticContentValidation",
                        type: resolveAtRuntime("value"),
                        description: resolveAtRuntime("Validating that accessibility.audioDescriptionSettings {{attribute}} is {{value}}")
                    }
                ]
            }
        ]
