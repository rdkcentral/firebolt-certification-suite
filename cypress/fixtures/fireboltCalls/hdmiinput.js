...
exports.SET_AUTOLOWLATENCYMODECAPABLE_WITH_INTEGER = {
  method: 'manage_hdmiinput.setAutoLowLatencyModeCapable',
  params: this.STATIC_VARIABLES.HDMIINPUT_VARIABLES.AUTOLOWLATENCYMODECAPABLE_INTEGER_HDMI1,
  content: 'error',
};
...
exports.SET_AUTOLOWLATENCYMODECAPABLE_WITHOUT_PORT = {
  method: 'manage_hdmiinput.setAutoLowLatencyModeCapable',
  params: this.STATIC_VARIABLES.HDMIINPUT_VARIABLES.AUTOLOWLATENCYMODECAPABLE_TRUE_WITHOUT_PORT,
  content: 'error',
};
...
exports.TRUE_FOR_HDMIINPUT_ONAUTOLOWLATENCYMODESIGNALCHANGED_EVENT = {
  ...
  validationJsonPath: 'eventResponse',
  content: this.STATIC_VARIABLES.HDMIINPUT_CONTENT.HDMIINPUT_ONAUTOLOWLATENCYMODESIGNALCHANGED_TRUE,
};
exports.FALSE_FOR_HDMIINPUT_ONAUTOLOWLATENCYMODESIGNALCHANGED_EVENT = {
  event: 'manage_hdmiinput.onAutoLowLatencyModeSignalChanged',
  validationJsonPath: 'eventResponse',
  content:
    this.STATIC_VARIABLES.HDMIINPUT_CONTENT.HDMIINPUT_ONAUTOLOWLATENCYMODESIGNALCHANGED_FALSE,
};
